...
$devices = [
    ...
    "BTone analog 2" => [
        ...
        "instructions" => [
            "en" => [
                "Press the connect button to connect your device to the speakers. The button will start flashing and BTone 2 [class name] Speakers will be visible as a bluetooth device for pairing for 50 seconds.",
            ...
            "fi" => [
                "Paina connect-painiketta yhdistääksesi laitteesi kaiuttimiin. Painike alkaa vilkkua ja BTone 2 [luokan nimi] Speakers on näkyvissä bluetooth-laitteena paritusta varten 50s ajan.",
            ...
            "sv" => [
                "Tryck på connect-knappen för att ansluta din enhet till högtalarna. Knappen börjar blinka och BTone 2 [klassnamn] Speakers visas som en bluetooth-enhet för parkoppling i 50 sekunder.",
